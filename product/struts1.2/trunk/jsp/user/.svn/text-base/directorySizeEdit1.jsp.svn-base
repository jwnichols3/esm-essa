...
<h2><bean:message key="directory_size.title.edit"/></h2>

<html:errors/>

<html:form action="/user/directorySizeEditAction?action=update" focus="directory">
  <table width="0%" border="0">  
    ...
    <tr>
      <td class="hdright"><bean:message key="directory_size.form.active"/>:</td>
