...
<h2><bean:message key="fs_size.title.edit"/></h2>

<html:errors/>

<html:form action="/user/fileSystemSizeEditAction?action=update" focus="name">
  <table width="0%" border="0">
    ...
    <tr>
      <td class="hdright"><bean:message key="fs_size.form.active"/>:</td>
      <td class="input" colspan="5"><html:checkbox property="active"/></td>
    </tr>
