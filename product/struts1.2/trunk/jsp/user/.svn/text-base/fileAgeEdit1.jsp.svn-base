...
<h2><bean:message key="file_age.title.edit"/></h2>

<html:errors/>

<html:form action="/user/fileAgeEditAction?action=update" focus="name">
  <table width="0%" border="0">
    ...
    <tr>
      <td class="hdright"><bean:message key="file_age.form.active"/>:</td>
