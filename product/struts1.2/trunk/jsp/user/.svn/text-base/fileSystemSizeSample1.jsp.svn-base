<!--
  Title: fileSystemSizeSample1.jsp
  Description: Display all file system size samples.
...
<h2><bean:message key="fs_size.title.sample"/></h2>
...
<table width="0%" border="1">
  <tr>
    ...
    <th class="hdmiddle">
      <bean:message key="fs_size.column.rule_row_id"/>
    </th>
    
    <th class="hdmiddle">
      <bean:message key="fs_size.column.sample_time"/>
    </th>
 
    <th class="hdmiddle">
      <bean:message key="fs_size.column.exists"/>
    </th>
    
    <th class="hdmiddle">
      <bean:message key="fs_size.column.block"/>
    </th>
       
    <th class="hdmiddle">
      <bean:message key="fs_size.column.inode"/>
    </th>
               
    <th class="hdmiddle">
      <bean:message key="fs_size.column.rule_match"/>
    </th>
    
    <th class="hdmiddle">
      <bean:message key="fs_size.column.suppress"/>
    </th>
  ...
  <logic:iterate id="ndx1" name="sample_list">
    <tr>
      ...
      <td class="fine">
        <bean:write name="ndx1" property="blockPercentage"/>
      </td>
     
      <td class="fine">
        <bean:write name="ndx1" property="inodePercentage"/>
      </td>
