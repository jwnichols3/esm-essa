<!--
  Title: fileSizeSample1.jsp
  Description: Display all file size samples.
...
<h2><bean:message key="file_size.title.sample"/></h2>
...
<table width="0%" border="1">
  <tr>
    ...
    <th class="hdmiddle">
      <bean:message key="file_size.column.rule_row_id"/>
    </th>
    
    <th class="hdmiddle">
      <bean:message key="file_size.column.sample_time"/>
    </th>
 
    <th class="hdmiddle">
      <bean:message key="file_size.column.exists"/>
    </th>
    
    <th class="hdmiddle">
      <bean:message key="file_size.column.bytes"/>
    </th>
       
    <th class="hdmiddle">
      <bean:message key="file_size.column.rule_match"/>
    </th>
    
    <th class="hdmiddle">
      <bean:message key="file_size.column.suppress"/>
    </th>
