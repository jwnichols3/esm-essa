...
<h2><bean:message key="file_size.title.edit"/></h2>

<html:errors/>

<html:form action="/user/fileSizeEditAction?action=update" focus="name">
  <table width="0%" border="0">
    ...
    <tr>
      <td class="hdright"><bean:message key="file_size.form.active"/>:</td>
