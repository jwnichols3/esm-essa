...
<h2><bean:message key="boot_time.title.edit"/></h2>

<html:errors/>

<html:form action="/user/bootTimeEditAction?action=update" focus="name">
  <table width="0%" border="0">
    <tr>
      <td class="hdright"><bean:message key="boot_time.form.active"/>:</td>
