...
/**
 * Prepare to service "file size" rule operations
 * 
 * @struts.action 
 *   name="fileSizeForm" 
 *   path="/user/fileSizePrepAction"
 *   scope="request" 
 *   validate="false"
 *
 * @struts.action-forward 
 *   name="audit_rule" 
 *   path="file_size.audit.page"
 *   
 * @struts.action-forward 
 *   name="browse_rule" 
 *   path="file_size.browse.page"
 * 
 * @struts.action-forward 
 *   name="browse_sample" 
 *   path="file_size.sample.page"
 *   
 * @struts.action-forward 
 *   name="edit_rule" 
 *   path="file_size.edit.page"
 *   
 * @struts.action-forward 
 *   name="new_rule" 
 *   path="file_size.new.page"
 *  
 * @struts.action-forward 
 *   name="session_reset" 
 ...
 */
public final class FileSizePrepAction extends AbstractFileSizeAction {
	...
	public ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request, final HttpServletResponse response) throws Exception {
		_log.debug("entry into FileSizePrepAction.execute()");
		
		String forward = StrutsConstantsIf.FAILURE;
		
		try {
			forward = actionLogic(request, (FileSizeForm) form);
		} catch(Exception exception) {
			_log.error("FileSizePrepAction", exception);
		}

		_log.debug("FileSizePrepAction forward:" + forward);
	 ...
	 */
	private String actionLogic(HttpServletRequest request, FileSizeForm form) {
