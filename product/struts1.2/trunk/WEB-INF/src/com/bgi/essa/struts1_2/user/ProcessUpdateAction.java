...
/**
 * Edit existing "process" rule
 * 
 * @struts.action 
 *   name="processForm" 
 *   path="/user/processEditAction"
 ...
 */
public final class ProcessUpdateAction extends AbstractProcessAction {
	...
	public ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request, final HttpServletResponse response) throws Exception {
		_log.debug("entry into ProcessUpdateAction.execute()");
		...
		try {
			...
			_log.error("ProcessUpdateAction", exception);
		}

		_log.debug("ProcessUpdateAction forward:" + forward);
