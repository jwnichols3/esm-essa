...
/**
 * Edit existing "boot time" rule
 * 
 * @struts.action 
 *   name="bootTimeForm" 
 *   path="/user/bootTimeEditAction"
 *   input="reboot.edit.page"
 *   scope="request" 
 *   validate="true"
 *
 ...
 */
public final class BootTimeUpdateAction extends AbstractBootTimeAction {
	...
	public ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request, final HttpServletResponse response) throws Exception {
		_log.debug("entry into BootTimeUpdateAction.execute()");
		...
		try {
			...
			_log.error("BootTimeUpdateAction", exception);
		}

		_log.debug("BootTimeUpdateAction forward:" + forward);
