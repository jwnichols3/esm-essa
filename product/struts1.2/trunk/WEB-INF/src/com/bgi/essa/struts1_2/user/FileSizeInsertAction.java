...
/**
 * Insert new file size rule
 * 
 * @struts.action 
 *   name="fileSizeForm" 
 *   path="/user/fileSizeInsertAction"
 *   input="file_size.new.page" 
 *   scope="request" 
 *   validate="true"
 *   
 ...
 */
public final class FileSizeInsertAction extends AbstractFileSizeAction {
	...
	public ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request, final HttpServletResponse response) throws Exception {
		_log.debug("entry into FileSizeInsertAction.execute()");
		...
		try {
			...
			_log.error("FileSizeInsertAction", exception);
		}

		_log.debug("FileSizeInsertAction forward:" + forward);
