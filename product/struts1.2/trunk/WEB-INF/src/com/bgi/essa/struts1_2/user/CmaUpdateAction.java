...
/**
 * Edit existing CMA attribute
 * 
 * @struts.action 
 *   name="cmaForm" 
 *   path="/user/cmaEditAction"
 *   input="cma.edit.page"
 *   scope="request" 
 *   validate="true"
 *
 ...
 */
public final class CmaUpdateAction extends AbstractCmaAction {
	...
	public ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request, final HttpServletResponse response) throws Exception {
		_log.info("entry into CmaUpdateAction.execute()");
		...
		_log.info("CmaUpdateAction forward:" + forward);
