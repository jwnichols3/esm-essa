...
/**
 * Edit existing VPO attribute
 * 
 * @struts.action 
 *   name="vpoForm" 
 *   path="/user/vpoEditAction"
 *   input="vpo.edit.page"
 *   scope="request" 
 *   validate="true"
 *
 ...
 */
public final class VpoUpdateAction extends AbstractVpoAction {
	...
	public ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request, final HttpServletResponse response) throws Exception {
		_log.debug("entry into VpoUpdateAction.execute()");
		...
		try {
			...
			_log.error("VpoUpdateAction", exception);
		}

		_log.debug("VpoUpdateAction forward:" + forward);
