...
/**
 * Prepare to service "file system size" rule operations
 * 
 * @struts.action 
 *   name="fileSystemSizeForm" 
 *   path="/user/fileSystemSizePrepAction"
 *   scope="request" 
 *   validate="false"
 *   
 * @struts.action-forward 
 *   name="audit_rule" 
 *   path="file_system_size.audit.page"
 *   
 * @struts.action-forward 
 *   name="browse_rule" 
 *   path="file_system_size.browse.page"
 * 
 * @struts.action-forward 
 *   name="browse_sample" 
 *   path="file_system_size.sample.page"
 *   
 * @struts.action-forward 
 *   name="edit_rule" 
 *   path="file_system_size.edit.page"
 *   
 * @struts.action-forward 
 *   name="new_rule" 
 *   path="file_system_size.new.page"
 *  
 * @struts.action-forward 
 *   name="session_reset" 
 ...
 */
public final class FileSystemSizePrepAction extends AbstractFileSystemSizeAction {
	...
	public ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request, final HttpServletResponse response) throws Exception {
		_log.debug("entry into FileSystemSizePrepAction.execute()");

		String forward = StrutsConstantsIf.FAILURE;
		
		try {
			forward = actionLogic(request, (FileSystemSizeForm) form);
		} catch(Exception exception) {
			_log.error("FileSystemSizeInsertAction", exception);
		}

		_log.debug("FileSystemSizeInsertAction forward:" + forward);
	 ...
	 */
	private String actionLogic(HttpServletRequest request, FileSystemSizeForm form) {
