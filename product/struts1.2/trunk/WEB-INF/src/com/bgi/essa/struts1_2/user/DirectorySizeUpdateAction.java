...
/**
 * Edit existing "directory size" rule
 * 
 * @struts.action 
 *   name="directorySizeForm" 
 *   path="/user/directorySizeEditAction"
 *   input="directory_size.edit.page"
 *   scope="request" 
 *   validate="true"
 *
 ...
 */
public final class DirectorySizeUpdateAction extends AbstractDirectorySizeAction {
	...
	public ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request, final HttpServletResponse response) throws Exception {
		_log.debug("entry into DirectorySizeUpdateAction.execute()");
		...
		try {
			...
			_log.error("DirectorySizeUpdateAction", exception);
		}

		_log.debug("DirectorySizeUpdateAction forward:" + forward);
