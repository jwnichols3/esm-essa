...
/**
 * Insert new file age rule
 * 
 * @struts.action 
 *   name="directoryAgeForm" 
 *   path="/user/directoryAgeInsertAction"
 *   input="directory_age.new.page" 
 *   scope="request" 
 *   validate="true"
 *   
 ...
 * @author linden
 */
public final class DirectoryAgeInsertAction extends AbstractDirectoryAgeAction {
	...
	public ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request, final HttpServletResponse response) throws Exception {
		_log.debug("entry into DirectoryAgeInsertAction.execute()");
		...
		try {
			...
			_log.error("DirectoryAgeInsertAction", exception);
		}

		_log.debug("DirectoryAgeInsertAction forward:" + forward);
	...
	private String actionLogic(HttpServletRequest request, DirectoryAgeForm form) {
        ...
        _log.info ( "Value of DirectoryName: " + form.getDirectoryName() );
