...
/**
 * Insert new alarm inhibit window
 * 
 * @struts.action 
 *   name="alarmInhibitForm" 
 *   path="/user/alarmInhibitInsertAction"
 *   input="alarm_inhibit.new.page" 
 *   scope="request" 
 *   validate="true"
 *   
 ...
 */
public final class AlarmInhibitInsertAction extends AbstractAlarmInhibitAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		_log.info("entry into AlarmInhibitInsertAction.execute()");
		...
		try {
			...
			_log.error("AlarmInhibitInsertAction", exception);
		}

		_log.info("AlarmInhibitInsertAction forward:" + forward);
