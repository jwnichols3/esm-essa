...
/**
 * Insert new "canned action" attribute
 * 
 * @struts.action 
 *   name="cannedForm" 
 *   path="/user/cannedInsertAction"
 *   input="canned.new.page" 
 *   scope="request" 
 *   validate="true"
 *
 ...
 */
public final class CannedInsertAction extends AbstractCannedAction {
	...
	public ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request, final HttpServletResponse response) throws Exception {
		_log.info("entry into CannedInsertAction.execute()");
		...
		try {
			...
			_log.error("CannedInsertAction", exception);
		}

		_log.info("CannedInsertAction forward:" + forward);
