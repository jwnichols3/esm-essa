 ...
 * @struts.action 
 *   name="fileAgeForm" 
 *   path="/user/fileAgeInsertAction"
 *   input="file_age.new.page" 
 *   scope="request" 
 *   validate="true"
 *   
 ...
 */
public final class FileAgeInsertAction extends AbstractFileAgeAction {
	...
	public ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request, final HttpServletResponse response) throws Exception {
		_log.debug("entry into FileAgeInsertAction.execute()");
		...
		try {
			...
			_log.error("FileAgeInsertAction", exception);
		}

		_log.debug("FileAgeInsertAction forward:" + forward);
