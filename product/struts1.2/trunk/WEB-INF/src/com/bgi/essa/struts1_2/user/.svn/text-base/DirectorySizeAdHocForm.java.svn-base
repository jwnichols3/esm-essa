 ...
 */
public class DirectorySizeAdHocForm extends EssaForm {

	/**
	 * empty ctor
	 */
	public DirectorySizeAdHocForm() {
		super();
	}
	...
	public ActionErrors validate(final ActionMapping mapping, final HttpServletRequest request) {
		...
		if ((_name == null) || (_name.length() < 1)) {
			errorz.add("name", new ActionMessage("dir_size.error.bad_name"));
		}
