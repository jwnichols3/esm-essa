...
/**
 * Utility class for QueueBean.
 * @xdoclet-generated at 10-02-07
 * @copyright The XDoclet Team
 * @author XDoclet
 * @version 1.3-SNAPSHOT
 */
public class QueueBeanUtil
{
  ...
  private static final java.lang.String CONNECTION_FACTORY_JNDI_NAME="";
    ...
    * @return Destination JMS Queue for QueueBean. Lookup using COMP_NAME
    */
   ...
   /**
    * Obtain destination queue from default initial context
    * @return Destination JMS Connection Factory for QueueBean. Lookup using COMP_NAME
    */
   ...
   public static final String generateGUID(Object o) {
       ...
       if (hexServerIP == null) {
           ...
           try {
               ...
               System.err.println("QueueBeanUtil: Could not get the local IP address using InetAddress.getLocalHost()!");
