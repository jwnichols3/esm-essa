...
/**
 * Map Hibernate UserType to Hour.  This is a single column mapping.
 *
 * @author G.S. Cole (guycole at gmail dot com)
 */
public class HourUserType implements UserType {
    ...
    public Object assemble(Serializable cached, Object owner) throws HibernateException {
        //fixme
        _log.warn("HourUserType.assemble");
        return(null);
    }
    ...
    public Serializable disassemble(Object arg) throws HibernateException {
        //fixme
        _log.warn("HourUserType.disassemble");
        return(null);
    }
    ...
    public Object replace(Object original, Object target, Object owner) throws HibernateException {
        //fixme
        _log.warn("HourUserType.replace");
        return(null);
    }
     ...
     * Hour is immutable
     *
     * @return false, Hour is immutable
     */
    ...
    public Object nullSafeGet(ResultSet result_set, String[] names, Object owner) throws HibernateException, SQLException {
        ...
        Hour temp = Hour.getInstance(result_set.getString(names[0]));
        if (temp == null) {
        	_log.error("unknown Hour");
        	return(Hour.H00);
        }
     ...
     * @return Java type mapped by UserType
     */
	public Class<Hour> returnedClass() {
        return(Hour.class);
    }

    /**
     * Return column type definitions.  Hour only has a single column.
     *
    ...
    /**
     * Column type definition, Hour only has a single column.
     */
     ...
     * Define logger
     */    
    private static final Log _log = LogFactory.getLog(HourUserType.class);
}