...
/**
 * Map Hibernate UserType to TrimString.  This is a single column mapping.
 *
 * @author G.S. Cole (guycole at gmail dot com)
 */
public class TrimStringUserType implements UserType {
    ...
    public Object assemble(Serializable cached, Object owner) throws HibernateException {
        //fixme
        _log.warn("TrimStringUserType.assemble");
        return(null);
    }
    ...
    public Serializable disassemble(Object arg) throws HibernateException {
        //fixme
        _log.warn("TrimStringUserType.disassemble");
        return(null);
    }
    ...
    public Object replace(Object original, Object target, Object owner) throws HibernateException {
        //fixme
        _log.warn("TrimStringUserType.replace");
        return(null);
    }
    ...
    /**
     * TrimString is immutable
     *
     * @return false, TrimString is immutable
     */
    ...
    /**
     * Populate TrimString from ResultSet
     *
    ...
    public Object nullSafeGet(ResultSet result_set, String[] names, Object owner) throws HibernateException, SQLException {
        ...
        return(new TrimString(result_set.getString(names[0])));
    }

    /**
     * Populate Statement from TrimString
     *
    ...
    public void nullSafeSet(PreparedStatement statement, Object value, int index) throws HibernateException, SQLException {
        if (value == null) {
        	...
        	TrimString trim_string = (TrimString) value;
        	statement.setString(index, trim_string.getValue());
        }
    }
     ...
     * @return Java type mapped by UserType
     */
	public Class<TrimString> returnedClass() {
        return(TrimString.class);
    }

    /**
     * Return column type definitions.  TrimString only has a single column.
     *
     ...
     * Define logger
     */    
    private static final Log _log = LogFactory.getLog(TrimStringUserType.class);
}