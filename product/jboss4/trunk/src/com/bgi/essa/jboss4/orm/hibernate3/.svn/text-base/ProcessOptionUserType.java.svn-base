...
/**
 * Map Hibernate UserType to ProcessOption.  This is a single column mapping.
 * 
 * @author coleguy
 */
public class ProcessOptionUserType implements UserType {
    ...
    public Object assemble(Serializable cached, Object owner) throws HibernateException {
        //fixme
        _log.warn("ProcessOptionUserType.assemble");
        return(null);
    }
    ...
    public Serializable disassemble(Object arg) throws HibernateException {
        //fixme
        _log.warn("ProcessOptionUserType.disassemble");
        return(null);
    }
    ...
    public Object replace(Object original, Object target, Object owner) throws HibernateException {
        //fixme
        _log.warn("ProcessOptionUserType.replace");
        return(null);
    }
    ...
    /**
     * ProcessOption is immutable
     *
     * @return false, ProcessOption is immutable
     */
    ...
    /**
     * Populate ProcessOption from ResultSet
     *
    ...
    public Object nullSafeGet(ResultSet result_set, String[] names, Object owner) throws HibernateException, SQLException {
        ...
        ProcessOption temp = ProcessOption.getInstance(result_set.getString(names[0]));
        if (temp == null) {
        	_log.error("unknown file age option");
        	return(ProcessOption.PROCESS_NAME);
        }
    ...
    /**
     * Populate Statement from ProcessOption
     *
    ...
    public void nullSafeSet(PreparedStatement statement, Object value, int index) throws HibernateException, SQLException {
        if (value == null) {
        	...
        	ProcessOption temp = (ProcessOption) value;
     ...
     * @return Java type mapped by UserType
     */
	public Class<ProcessOption> returnedClass() {
        return(ProcessOption.class);
    }

    /**
     * Return column type definitions.  ProcessOption only has a single column.
     *
    ...
    /**
     * Column type definition, ProcessOption only has a single column.
     */
     ...
     * Define logger
     */   
    private static final Log _log = LogFactory.getLog(ProcessOptionUserType.class);
}
