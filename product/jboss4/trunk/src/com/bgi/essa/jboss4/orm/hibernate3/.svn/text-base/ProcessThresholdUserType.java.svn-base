...
/**
 * Map Hibernate UserType to ProcessThreshold.  This is a single column mapping.
 * 
 * @author coleguy
 */
public class ProcessThresholdUserType implements UserType {
    ...
    public Object assemble(Serializable cached, Object owner) throws HibernateException {
        //fixme
        _log.warn("ProcessThresholdUserType.assemble");
        return(null);
    }
    ...
    public Serializable disassemble(Object arg) throws HibernateException {
        //fixme
        _log.warn("ProcessThresholdUserType.disassemble");
        return(null);
    }
    ...
    public Object replace(Object original, Object target, Object owner) throws HibernateException {
        //fixme
        _log.warn("ProcessThresholdUserType.replace");
        return(null);
    }
    ...
    /**
     * ProcessThreshold is immutable
     *
     * @return false, ProcessThreshold is immutable
     */
    ...
    /**
     * Populate ProcessThreshold from ResultSet
     *
    ...
    public Object nullSafeGet(ResultSet result_set, String[] names, Object owner) throws HibernateException, SQLException {
        ...
        ProcessThreshold temp = ProcessThreshold.getInstance(result_set.getString(names[0]));
        if (temp == null) {
        	_log.error("unknown file age option");
        	return(ProcessThreshold.ALWAYS_RUN);
        }
    ...
    /**
     * Populate Statement from ProcessThreshold
     *
    ...
    public void nullSafeSet(PreparedStatement statement, Object value, int index) throws HibernateException, SQLException {
        if (value == null) {
        	...
        	ProcessThreshold temp = (ProcessThreshold) value;
     ...
     * @return Java type mapped by UserType
     */
	public Class<ProcessThreshold> returnedClass() {
        return(ProcessThreshold.class);
    }

    /**
     * Return column type definitions.  ProcessThreshold only has a single column.
     *
    ...
    /**
     * Column type definition, ProcessThreshold only has a single column.
     */
     ...
     * Define logger
     */   
    private static final Log _log = LogFactory.getLog(ProcessThresholdUserType.class);
}
