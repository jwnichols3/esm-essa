...
/**
 * Evaluate queue writer
 * 
 * @author coleguy
 */
public class EvaluateQueue {
	...
	public boolean queueWriter(DtoIf arg) {
		try {
			...
			Queue queue = (Queue) context.lookup(ConstantsIf.EVALUATE_QUEUE);
	 ...
	 * Logger
	 */
	private final Log _log = LogFactory.getLog(EvaluateQueue.class);
}
