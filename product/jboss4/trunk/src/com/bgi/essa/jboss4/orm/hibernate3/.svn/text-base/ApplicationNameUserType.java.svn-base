...
/**
 * Map Hibernate UserType to ApplicationName.  This is a single column mapping.
 *
 * @author G.S. Cole (guycole at gmail dot com)
 */
public class ApplicationNameUserType implements UserType {
    ...
    public Object assemble(Serializable cached, Object owner) throws HibernateException {
        //fixme
        _log.warn("ApplicationNameUserType.assemble");
        return(null);
    }
    ...
    public Serializable disassemble(Object arg) throws HibernateException {
        //fixme
        _log.warn("ApplicationNameUserType.disassemble");
        return(null);
    }
    ...
    public Object replace(Object original, Object target, Object owner) throws HibernateException {
        //fixme
        _log.warn("ApplicationNameUserType.replace");
        return(null);
    }
    ...
    /**
     * ApplicationName is immutable
     *
     * @return false, ApplicationName is immutable
     */
    ...
    /**
     * Populate ApplicationName from ResultSet
     *
    ...
    public Object nullSafeGet(ResultSet result_set, String[] names, Object owner) throws HibernateException, SQLException {
        ...
        ApplicationName temp = ApplicationName.getInstance(result_set.getString(names[0]));
        if (temp == null) {
        	_log.error("unknown application name");
        	return(ApplicationName.ESM);
        }
    ...
    /**
     * Populate Statement from ApplicationName
     *
    ...
    public void nullSafeSet(PreparedStatement statement, Object value, int index) throws HibernateException, SQLException {
        if (value == null) {
        	...
        	ApplicationName temp = (ApplicationName) value;
     ...
     * @return Java type mapped by UserType
     */
	public Class<ApplicationName> returnedClass() {
        return(ApplicationName.class);
    }
     ...
     * Define logger
     */    
    private static final Log _log = LogFactory.getLog(ApplicationNameUserType.class);
}
