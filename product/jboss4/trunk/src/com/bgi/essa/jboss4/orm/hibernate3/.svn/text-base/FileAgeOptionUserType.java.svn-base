...
/**
 * Map Hibernate UserType to FileAgeOption.  This is a single column mapping.
 * 
 * @author coleguy
 */
public class FileAgeOptionUserType implements UserType {
    ...
    public Object assemble(Serializable cached, Object owner) throws HibernateException {
        //fixme
        _log.warn("FileAgeOptionUserType.assemble");
        return(null);
    }
    ...
    public Serializable disassemble(Object arg) throws HibernateException {
        //fixme
        _log.warn("FileAgeOptionUserType.disassemble");
        return(null);
    }
    ...
    public Object replace(Object original, Object target, Object owner) throws HibernateException {
        //fixme
        _log.warn("FileAgeOptionUserType.replace");
        return(null);
    }
    ...
    /**
     * FileAgeOption is immutable
     *
     * @return false, FileAgeOption is immutable
     */
    ...
    /**
     * Populate FileAgeOption from ResultSet
     *
    ...
    public Object nullSafeGet(ResultSet result_set, String[] names, Object owner) throws HibernateException, SQLException {
        ...
        FileAgeOption temp = FileAgeOption.getInstance(result_set.getString(names[0]));
        if (temp == null) {
        	_log.error("unknown file age option");
        	return(FileAgeOption.ALL);
        }
    ...
    /**
     * Populate Statement from FileAgeOption
     *
    ...
    public void nullSafeSet(PreparedStatement statement, Object value, int index) throws HibernateException, SQLException {
        if (value == null) {
        	...
        	FileAgeOption temp = (FileAgeOption) value;
     ...
     * @return Java type mapped by UserType
     */
	public Class<FileAgeOption> returnedClass() {
        return(FileAgeOption.class);
    }

    /**
     * Return column type definitions.  FileAgeOption only has a single column.
     *
    ...
    /**
     * Column type definition, FileAgeOption only has a single column.
     */
     ...
     * Define logger
     */   
    private static final Log _log = LogFactory.getLog(FileAgeOptionUserType.class);
}
