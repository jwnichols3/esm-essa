...
/**
 * Map Hibernate UserType to CannedAction.  This is a single column mapping.
 *
 * @author G.S. Cole (guycole at gmail dot com)
 */
public class CannedActionUserType implements UserType {
    ...
    public Object assemble(Serializable cached, Object owner) throws HibernateException {
        //fixme
        _log.warn("CannedActionUserType.assemble");
        return(null);
    }
    ...
    public Serializable disassemble(Object arg) throws HibernateException {
        //fixme
        _log.warn("CannedActionUserType.disassemble");
        return(null);
    }
    ...
    public Object replace(Object original, Object target, Object owner) throws HibernateException {
        //fixme
        _log.warn("CannedActionUserType.replace");
        return(null);
    }
    ...
    /**
     * CannedAction is immutable
     *
     * @return false, CannedAction is immutable
     */
    ...
    /**
     * Populate CannedAction from ResultSet
     *
    ...
    public Object nullSafeGet(ResultSet result_set, String[] names, Object owner) throws HibernateException, SQLException {
        ...
        CannedAction temp = CannedAction.getInstance(result_set.getString(names[0]));
        if (temp == null) {
        	_log.error("unknown CannedAction");
        	return(CannedAction.EMAIL);
        }
    ...
    /**
     * Populate Statement from CannedAction
     *
    ...
    public void nullSafeSet(PreparedStatement statement, Object value, int index) throws HibernateException, SQLException {
        if (value == null) {
        	...
        	CannedAction temp = (CannedAction) value;
     ...
     * @return Java type mapped by UserType
     */
	public Class<CannedAction> returnedClass() {
        return(CannedAction.class);
    }

    /**
     * Return column type definitions.  CannedAction only has a single column.
     *
    ...
    /**
     * Column type definition, CannedAction only has a single column.
     */
     ...
     * Define logger
     */    
    private static final Log _log = LogFactory.getLog(CannedActionUserType.class);
}