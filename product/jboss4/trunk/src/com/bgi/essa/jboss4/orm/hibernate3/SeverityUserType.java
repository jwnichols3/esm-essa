...
/**
 * Map Hibernate UserType to Severity.  This is a single column mapping.
 *
...
public class SeverityUserType implements UserType {
    ...
    public Object assemble(Serializable cached, Object owner) throws HibernateException {
        //fixme
        _log.warn("SeverityUserType.assemble");
        return(null);
    }
    ...
    public Serializable disassemble(Object arg) throws HibernateException {
        //fixme
        _log.warn("SeverityUserType.disassemble");
        return(null);
    }
    ...
    public Object replace(Object original, Object target, Object owner) throws HibernateException {
        //fixme
        _log.warn("SeverityUserType.replace");
        return(null);
    }
     ...
     *
     * @return false, Severity is immutable
     */
    ...
    /**
     * Populate Severity from ResultSet
     *
    ...
    public Object nullSafeGet(ResultSet result_set, String[] names, Object owner) throws HibernateException, SQLException {
        ...
        Severity temp = Severity.getInstance(result_set.getString(names[0]));
        if (temp == null) {
        	_log.error("unknown severity");
    ...
    /**
     * Populate Statement from Severity
     *
    ...
    /**
     * Return column type definitions.  Severity only has a single column.
     *
    ...
    /**
     * Column type definition, Severity only has a single column.
     */
     ...
     * Define logger
     */    
    private static final Log _log = LogFactory.getLog(SeverityUserType.class);
}