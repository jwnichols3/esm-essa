...
/**
 * Map Hibernate UserType to FauxBoolean.  This is a single column mapping.
 *
 * @author G.S. Cole (guycole at gmail dot com)
 */
public class FauxBooleanUserType implements UserType {
    ...
    public Object assemble(Serializable cached, Object owner) throws HibernateException {
        //fixme
        _log.warn("FauxBooleanUserType.assemble");
        return(null);
    }
    ...
    public Serializable disassemble(Object arg) throws HibernateException {
        //fixme
        _log.warn("FauxBooleanUserType.disassemble");
        return(null);
    }
    ...
    public Object replace(Object original, Object target, Object owner) throws HibernateException {
        //fixme
        _log.warn("FauxBooleanUserType.replace");
        return(null);
    }
    ...
    /**
     * FauxBoolean is immutable
     *
     * @return true, FauxBoolean is immutable
     */
    ...
    /**
     * Populate FauxBoolean from ResultSet
     *
    ...
    public Object nullSafeGet(ResultSet result_set, String[] names, Object owner) throws HibernateException, SQLException {
        ...
        return(new FauxBoolean(result_set.getString(names[0])));
    }

    /**
     * Populate Statement from FauxBoolean
     *
    ...
    public void nullSafeSet(PreparedStatement statement, Object value, int index) throws HibernateException, SQLException {
        if (value == null) {
        	...
        	FauxBoolean fb = (FauxBoolean) value;
        	statement.setString(index, fb.getStringValue());
        }
    }
	...
	public Class returnedClass() {
        return(FauxBoolean.class);
    }
    
    /**
     * Return column type definitions.  FauxBoolean only has a single column.
     *
     ...
     * Define logger
     */    
    private static final Log _log = LogFactory.getLog(FauxBooleanUserType.class);
}