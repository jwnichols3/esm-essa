...
create table quartz.qrtz_job_listeners (
job_name varchar(80) not null,
job_group varchar(80) not null,
job_listener varchar(80) not null,
primary key (job_name,job_group,job_listener),
foreign key (job_name,job_group) references quartz.qrtz_job_details(job_name,job_group)
);
...
primary key (trigger_name,trigger_group),
foreign key (trigger_name,trigger_group) references quartz.qrtz_triggers(trigger_name,trigger_group)
);
...
create table quartz.qrtz_trigger_listeners (
trigger_name varchar(80) not null,
trigger_group varchar(80) not null,
...
insert into quartz.qrtz_locks values('TRIGGER_ACCESS');
insert into quartz.qrtz_locks values('JOB_ACCESS');
insert into quartz.qrtz_locks values('CALENDAR_ACCESS');
insert into quartz.qrtz_locks values('STATE_ACCESS');
insert into quartz.qrtz_locks values('MISFIRE_ACCESS');
