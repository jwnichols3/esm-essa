 ...
 * @author coleguy
 */
public class FileSystemSizeSampleDtoTest extends TestCase {

	/**
	 * @param name
	 */
	public FileSystemSizeSampleDtoTest(final String name) {
		super(name);
	}
	...
	public void test01() {
		...
		final FileSystemSizeSampleDTO dto1 = new FileSystemSizeSampleDTO();
	 ...
	 * Logger
	 */
	private final Log _log = LogFactory.getLog(FileSystemSizeSampleDtoTest.class);
}
