 ...
 * @author coleguy
 */
public class ProcessSampleDtoTest extends TestCase {

	/**
	 * @param name
	 */
	public ProcessSampleDtoTest(String name) {
		super(name);
	}
	...
	public void test01() {
		...
		ProcessSampleDTO dto1 = new ProcessSampleDTO();
	...
	public void test02() {
		...
		//
		dto1.setPid(1234);
		assertEquals("test02e", 1234, dto1.getPid());
		
		//
		// process name
		//
		dto1.setName(new TrimString("testaroo"));
		assertTrue("test02f", dto1.getName().equals("testaroo"));
		
		//
		// population
		//
		dto1.setPopulation(4321);
		assertEquals("test02g", 4321, dto1.getPopulation());
		
		//
		// cpu time
		//
		dto1.setCpuTime(5678);
		assertEquals("test02h", 5678, dto1.getCpuTime());
		
		//
		// exists
		//
		dto1.setExists(true);
		assertTrue("test02i", dto1.isExists());
		dto1.setExists(false);
		assertFalse("test02j", dto1.isExists());
	}
