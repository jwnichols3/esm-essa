...
/**
 * Define a file age monitor/rule.
 * 
 * @hibernate.class 
 *   table = "FILE_AGE"
 *   
 * @author coleguy
 */
public class FileAgeDTO extends AbstractVersioned implements Cloneable, Comparable<Object> {
	...
	/**
	 * Return the file age option
	 * 
	 * @return file age option
	 *
     * @hibernate.property
     *   column="AGE_TYPE"
	...
	/**
	 * Define file age option
	 * 
	 * @param arg file age option
	 * @throws NullPointerException if null arg
	 */
	public void setFileAgeOption(FileAgeOption arg) {
		if (arg == null) {
			throw new NullPointerException("null file age option");
		}
	...
	/**
	 * Convenience method for struts FileAge pages
	 * 
	...
	public String toString() {
		String result = "fileage:" + _directory + ":" + _file_name + ":" + _threshold + ":" + _option + ":" + super.toString();
		return(result);
	}
	 ...
	 */
	public Object clone() {
		final FileAgeDTO dto = new FileAgeDTO();
	...
	public boolean isReasonable() {
		System.out.println("FileAgeDTO fix me/isReasonable");
		return(true);
	}
	...
	public int compareTo(final Object arg) {
		System.out.println("FIXME FileAgeDTO.compareTO");
		return(0);
