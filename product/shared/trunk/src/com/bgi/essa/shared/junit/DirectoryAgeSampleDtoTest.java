 ...
 * @author linden
 */
public class DirectoryAgeSampleDtoTest extends TestCase {

	/**
	 * @param name
	 */
	public DirectoryAgeSampleDtoTest(final String name) {
		super(name);
	}
	...
	public void test01() {
		...
		DirectoryAgeSampleDTO dto1 = new DirectoryAgeSampleDTO();
	...
	public void test02() {
		...
		// directory name test
		//
		dto1.setDirectoryName(new TrimString("big bogus"));
		assertTrue("test02e", dto1.getDirectoryName().equals("big bogus"));
	 ...
	 * Logger
	 */
	private final Log _log = LogFactory.getLog(DirectoryAgeSampleDtoTest.class);
}
