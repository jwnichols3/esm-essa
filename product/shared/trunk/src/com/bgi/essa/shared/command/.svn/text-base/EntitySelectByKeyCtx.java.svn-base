...
/**
 * Select an entity by key (key depends upon specific table)
 * 
 * @author gsc
 */
public class EntitySelectByKeyCtx extends AbstractEntityCtx {
	...
	public LegalCmd getCommand() {
		return(LegalCmd.SELECT_BY_KEY_CMD);
	}
	 ...
	 */
	private static final long serialVersionUID = 5894902461187299615L;
}
