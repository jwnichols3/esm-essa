 ...
 * @author coleguy
 */
public class BootTimeSampleDtoTest extends TestCase {

	/**
	 * @param name
	 */
	public BootTimeSampleDtoTest(String name) {
		super(name);
	}
	...
	public void test01() {
		...
		BootTimeSampleDTO dto1 = new BootTimeSampleDTO();
	...
	public void test02() {
		...
		//
		//
		dto1.setBootTime(zt1);
		assertTrue("test02e", dto1.getBootTime().equals(zt1));
